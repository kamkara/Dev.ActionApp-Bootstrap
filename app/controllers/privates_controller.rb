class PrivatesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @private.save
        format.html { redirect_to private_url(@private), notice: "Private was successfully created." }
  ...
  def update
    respond_to do |format|
      if @private.update(private_params)
        format.html { redirect_to private_url(@private), notice: "Private was successfully updated." }
  ...
  private
    ...
    def private_params
      params.require(:private).permit(:title, :content, :user_id)
    end
end
