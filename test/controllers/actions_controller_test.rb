...
class ActionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create action" do
    assert_difference("Action.count") do
      post actions_url, params: { action: { content: @action.content, objectif: @action.objectif, slug: @action.slug, status: @action.status, title: @action.title, user_id: @action.user_id } }
    end
  ...
  test "should update action" do
    patch action_url(@action), params: { action: { content: @action.content, objectif: @action.objectif, slug: @action.slug, status: @action.status, title: @action.title, user_id: @action.user_id } }
