...
class LegalsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create legal" do
    assert_difference("Legal.count") do
      post legals_url, params: { legal: { content: @legal.content, title: @legal.title, user_id: @legal.user_id } }
    end
  ...
  test "should update legal" do
    patch legal_url(@legal), params: { legal: { content: @legal.content, title: @legal.title, user_id: @legal.user_id } }
