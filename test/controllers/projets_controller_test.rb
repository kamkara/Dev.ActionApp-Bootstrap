...
class ProjetsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create projet" do
    assert_difference("Projet.count") do
      post projets_url, params: { projet: { amount: @projet.amount, content: @projet.content, heroImg: @projet.heroImg, slug: @projet.slug, start_date: @projet.start_date, status: @projet.status, title: @projet.title, user_id: @projet.user_id } }
    end
  ...
  test "should update projet" do
    patch projet_url(@projet), params: { projet: { amount: @projet.amount, content: @projet.content, heroImg: @projet.heroImg, slug: @projet.slug, start_date: @projet.start_date, status: @projet.status, title: @projet.title, user_id: @projet.user_id } }
